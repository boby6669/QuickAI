...
//   {to: '/ai/blog-titles', label: 'Blog Titels', Icon: Hash},
...
//   return (
//     <div className={`w-60 bg-white border-r border-gray-200 flex flex-con justify-between 
...
import React from 'react'
import { NavLink } from 'react-router-dom'   // ✅ यह missing था
