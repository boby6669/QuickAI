...
//       Creations
//       <div className='flex-1 h-full rounded-xl overflow-y-scroll flex flex-wrap gap-4'>
...
//                 <p className='text-sm hidde group-hover:block'>{creation.prompt}</p>
...
const Community = () => {
  ...
  return !loading ? (
    <div className='flex-1 h-full flex flex-col gap-4 p-6'>
      ...
      {/* Grid Layout */}
      <div className="flex-1 h-full rounded-xl overflow-y-scroll">
